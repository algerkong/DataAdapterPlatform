    ...
    <t-form ref="form" :data="formData" :label-width="80" colon>
      <t-row>
        ...
        <t-col :span="2" class="operation-container">
          <t-button theme="primary" type="submit" :style="{ marginLeft: 'var(--td-comp-margin-s)' }" @click="fetchData">
            查询
          </t-button>
          <t-button type="reset" variant="base" theme="default" @click="searchReset"> 重置 </t-button>
        </t-col>
      </t-row>
    </t-form>
